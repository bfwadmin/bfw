		...
		<div class="tools">
			<form method="get" action="">
				<input type="hidden" name="<?=CONTROL_NAME?>" value="Article" /> <input
					...
					<li onclick="location.href='<?=Bfw::ACLINK("Article","AddData")?>'"><span><img src="/statics/images/add.png" /></span>增加</li>
  	               </ul>
                    </div>
...
if (empty($itemdata)) {
    ...
    ?>
			...
			<thead>
				<tr>
					...
					<th >编号<i class="sort"><img src="/statics/images/px.gif" /></i></th>
					<th  >标题</th>
					<th  >类别</th>
    ...
    foreach ($itemdata as $item) {
        ?>  
					...
					<div class="bartool">
					<a href="<?=Bfw::ACLINK("Article","EditData","id=".$item['id'])?>">编辑</a>
