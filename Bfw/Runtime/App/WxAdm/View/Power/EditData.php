                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="" method="post">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-name" name="powername"  value="<?=$itemdata['powername']?>"  placeholder="名称">
                                   ...
                                   <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-name" name="controlname"  placeholder="控制器名称"  value="<?=$itemdata['controlname']?>">
                                   ...
                                   <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-name" name="actionname" placeholder="动作器名称"  value="<?=$itemdata['actionname']?>">
                                   ...
                                   <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-name" name="domianname" placeholder="域名称"  value="<?=$itemdata['domianname']?>">
                              ...
                              <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                    <?=HtmlUtil::Option("pid", $powerdata,$itemdata['pid'])?>
                                    </div>
                                </div>
                                  ...
                                  <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                       <?=HtmlUtil::Option("ismenu", ["0"=>"否","1"=>"是"] ,$itemdata['ismenu'])?>
