...
use Plugin\OSS\Core\MimeTypes;
use Plugin\OSS\Core\OssException;
use Plugin\OSS\Http\RequestCore;
use Plugin\OSS\Http\RequestCore_Exception;
use Plugin\OSS\Http\ResponseCore;
use Plugin\OSS\Model\CorsConfig;
use Plugin\OSS\Model\CnameConfig;
use Plugin\OSS\Model\LoggingConfig;
use Plugin\OSS\Result\AclResult;
use Plugin\OSS\Result\BodyResult;
use Plugin\OSS\Result\GetCorsResult;
use Plugin\OSS\Result\GetLifecycleResult;
use Plugin\OSS\Result\GetLoggingResult;
use Plugin\OSS\Result\GetRefererResult;
use Plugin\OSS\Result\GetWebsiteResult;
use Plugin\OSS\Result\GetCnameResult;
use Plugin\OSS\Result\HeaderResult;
use Plugin\OSS\Result\InitiateMultipartUploadResult;
use Plugin\OSS\Result\ListBucketsResult;
use Plugin\OSS\Result\ListMultipartUploadResult;
use Plugin\OSS\Model\ListMultipartUploadInfo;
use Plugin\OSS\Result\ListObjectsResult;
use Plugin\OSS\Result\ListPartsResult;
use Plugin\OSS\Result\PutSetDeleteResult;
use Plugin\OSS\Result\ExistResult;
use Plugin\OSS\Model\ObjectListInfo;
use Plugin\OSS\Result\UploadPartResult;
